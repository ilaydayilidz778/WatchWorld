...
namespace Infrastructure.Data
{
    public class EfRepository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        // Sorgularımızı daha spesifik hale getirmek için kullanırız.
        // (tek bir nesne üzerinden tüm spesifik nitelikler kazandırabilecek where, orderby
        // gibi metodlerı içeriyor.)
